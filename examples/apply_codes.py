...
The graph settings, encoder, and seed below are the reference defaults
...
(32768 -> 2048) are shrunk from the reference defaults so the demo runs quickly on the
tiny bundled core.
"""
...
def main() -> None:
    ...
    # reference defaults except num_epochs (300 -> 20) and batch_size (32768 -> 2048), shrunk for the demo.
