...
<div class="gx">
  ...
  <header class="gx-hero reveal">
    ...
    <dl class="gx-stats" id="gx-stats" aria-label="Atlas totals">
      <div class="gx-stat"><dt>samples</dt><dd id="gx-n-samples">&hellip;</dd></div>
  ...
  <section class="gx-explore gx-explore--top">
    <div class="gx-explore-head reveal">
      ...
      <p class="gx-sub">Every card is one independent sample, a whole tissue section or TMA core, colored by
        the cell-state lineage the frozen model assigns each cell. Filter by condition, tissue, platform, or
        dataset, or search a site or cell type; toggle the column count to open a sample up.</p>
    </div>

    <div class="gx-controls" id="gx-controls">
      <div class="bb-count" id="bb-count"><b>&hellip;</b> samples</div>
      <input class="bb-search" id="bb-search" type="search" placeholder="Search a site, sample, or cell type, e.g. tonsil or macrophage&hellip;" aria-label="Search samples">
      ...
      <select class="bb-select" id="bb-dataset" aria-label="Filter by dataset"><option value="all">All datasets</option></select>
